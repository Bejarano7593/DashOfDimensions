...
public class Movimiento2 {
    ...
    public Movimiento2(Mapa2 map) 
    {
        ...
        obstaculos.add(mapa.C4);
        obstaculos.add(mapa.C5);
        obstaculos.add(mapa.Inv1);
        obstaculos.add(mapa.Inv2);
        obstaculos.add(mapa.Inv3);
        obstaculos.add(mapa.Inv4);
        obstaculos.add(mapa.Inv5);
        obstaculos.add(mapa.Inv6);
        obstaculos.add(mapa.Inv7);
        obstaculos.add(mapa.Inv8);
    }
