...
public class Movimiento5 {
    ...
    public Movimiento5(Mapa5 map) 
    {
        ...
        obstaculos.add(mapa.F1);
        obstaculos.add(mapa.F2);
        obstaculos.add(mapa.F3);
        obstaculos.add(mapa.F4);
        obstaculos.add(mapa.lava);
        obstaculos.add(mapa.lava1);
        obstaculos.add(mapa.lava2);
        obstaculos.add(mapa.lava3);
