...
public class Movimiento{
    ...
    public Movimiento(Mapa1 map1) 
    {
        ...
        obstaculos.add(mapa.jLabel3);
        obstaculos.add(mapa.jLabel4);
        obstaculos.add(mapa.jLabel7);
        obstaculos.add(mapa.jLabel12);
        obstaculos.add(mapa.jLabel17);
    }
